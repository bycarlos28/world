 ...
 <body>
    ...
    <div>
 	<?php
 		...
 		$conn = mysqli_connect('localhost','manolo','manolo123');
    ...
    <form method="get" action="world2.php" style="position: absolute; right: 0; top: 0; margin-right: 100px; margin-top: 75px;">
